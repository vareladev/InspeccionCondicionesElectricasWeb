																	...
																	<?php
																		...
																		if ($result->num_rows > 0) {
																			...
																			while($row = $result->fetch_assoc()) {
																				...
																				echo '
																					<tr>
																						<td colspan="3"><b>Hospital: </b></td>
																						<td colspan="3">'.$row["hos"].'</td>
																					</tr>
																					<tr>
																						<td colspan="3"><b>Área: </b></td>
																						<td colspan="3">'.$row["nombreArea"].'</td>
																					</tr>
																					<tr>
																						<td colspan="3"><b>Servicio análizado: </b></td>
																					...
																					<tr>
																						<td colspan="3"><b>Fecha de realización: </b></td>
																						<td colspan="3">'.$row["fecha2"].'</td>
																					<tr>
																					</tr>
																						<td colspan="3"><b>Hora de realización: </b></td>
																					...
																					<tr>
																						<td colspan="3"><b>Fecha de sincronización con el servidor: </b></td>
																					...
																					<tr>
																						<td colspan="6"><b>Resultados de verificación ambiental en las instalaciones:</b></td>
																					</tr>
																					';										
																			}
																		}
																		...
																		echo '<tr>
																				...
																				<td><b><center>Promedio</center></b></td>
																				<td><b><center>Estándar</center></b></td>
																				<td><b><center>Cumplimiento</center></b></td>
																			</tr>';
																		...
																		paramareport($idg, $id, 2, "Iluminación ambiental", "600 Lux (máximo)");
																		paramareport($idg, $id, 4, "Ruido ambiental", "65 dB (Máximo)");
																		paramareport($idg, $id, 5, "Temperatura ambiental", "de 22°C a 26°C");
																		paramareport($idg, $id, 6, "Humedad relativa", "de 30 % a 60%");
																		...
																		echo '
																			...
																			<tr>
																				<td colspan="6"><b>Comentarios:</b></td>
																			</tr>
																			<tr>
																				<td colspan="6">'.$comentario.'</td>
																			</tr>
																		';
