...
<head>
	...
	<?php
		include 'reporte-detail-rec-chart.php';
	?>
	</script>
                                    ...
                                    <div class="row">
												...
												<div class="card">
													<div class="card-header">
														<h4>Inspecciones de receptáculos eléctricos realizadas en: <br><?php echo get_hospital_name($_GET['idh']); ?> </h4>
														<span>Los parámetros análizados son: Polaridad, vfaseneutro, vneutrotierra y vfasetierra.</span>
													</div>
													<div style="width:100%; padding:20px;">
														Evaluación general del cumplimiento del estándar, tomando en cuenta todas las mediciones realizadas en el hospital, relacionadas a la inspección de receptáculos eléctricos: Polaridad, vfaseneutro, vneutrotierra y vfasetierra..
													</div>
													...
													<table style="width:100%;" border="0">
														...
														<td style="width:50%; display: inline-block;">
															<div id="piechart_pol" style="width: 100%; height: 300px;"></div>
														</td>
														<td style="width:50%; display: inline-block;">
															<div id="piechart_vfaseneutro" style="width: 100%; height: 300px;"></div>
														</td>
														</tr>
														<tr>
														<tr>
														<td style="width:50%; display: inline-block;">
															<div id="piechart_vneutrotierra" style="width: 100%; height: 300px;"></div>
														</td>
														<td style="width:50%; display: inline-block;">
															<div id="piechart_vfasetierra" style="width: 100%; height: 300px;"></div>
														</td>
														</tr>
														<tr>
													</table>
